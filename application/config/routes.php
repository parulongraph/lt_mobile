...
$route['api/authentication/reset_password'] = 'api/authentication/reset_password';
$route['api/authentication/user_profile/(:num)(\.)([a-zA-Z0-9_-]+)(.*)'] = 'api/authentication/user_profile/id/$1/format/$3$4';
$route['api/user/view_service/(:num)(\.)([a-zA-Z0-9_-]+)(.*)'] = 'api/user/view_service/id/$1';
$route['api/user/add_services'] = 'api/user/add_services';
$route['api/user/edit_service'] = 'api/user/edit_service';
$route['api/customer/add_customer'] = 'api/customer/add_customer';
$route['api/customer/view_customer/(:num)(\.)([a-zA-Z0-9_-]+)(.*)'] = 'api/customer/view_customer/id/$1';
$route['api/customer/edit_customer'] = 'api/customer/edit_customer';
//$route['api/user/user_Profile/(:num)(\.)([a-zA-Z0-9_-]+)(.*)'] = 'api/user/user_Profile/id/$1';